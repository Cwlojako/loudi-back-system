  ...
  <div class="staff">
        ...
        >
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-button type="text" size="small"@click="showTypeDialog('编辑信息')">
                编辑
              </el-button>
    ...
    >
      <el-form :model="typeFormData" :rules="typeFormRule" ref="typeFormRef" label-width="100px" class="demo-ruleForm">
        <el-form-item label="机型名称" prop="name" required>
          <el-input v-model="typeFormData.name" placeholder="请输入"></el-input>
        </el-form-item>
        <el-form-item label="机型描述" prop="name" required>
          <el-input v-model="typeFormData.address" placeholder="请输入"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
        <el-button @click="typeDialogShow = false">取 消</el-button>
        <el-button type="primary" @click="typeDialogShow = false">确 定</el-button>
      </span>
    </el-dialog>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 前往维修记录详情页面
      gofixDetailPage() {
        this.$router.push({path:'/fix/fixDetail'});
      },
      // 前往店铺详情页面
      goShopDetail() {
