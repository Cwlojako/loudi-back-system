        ...
        <el-col :span="16">
          <div class="grid-content bg-purple-dark connectBaseInfo">
            ...
            <el-row>
              ...
              <div>
                <p>
                  <span class="connectTitle">顾客编号</span>
                  <span class="connectText">1354687945</span>
                  <span class="connectTitle">客户来源</span>
                  <span class="connectText">恋大自然官方体验店%</span>
                </p>
                <p>
                  <span class="connectTitle">姓名</span>
                  <span class="connectText">刘德华</span>
                  <span class="connectTitle">客户类别</span>
                  <span class="connectText">疗程顾客</span>
                </p>
                <p>
                  <span class="connectTitle">性别</span>
                  <span class="connectText">已合作</span>
                  <span class="connectTitle">疗程客户子类别</span>
                  <span class="connectText">按次疗程客户</span>
                </p>
                <p>
                  <span class="connectTitle">出生年月</span>
                  <span class="connectText">1975-6-15</span>
                  <span class="connectTitle">客户属性</span>
                  <span class="connectText">普通客户</span>
                </p>
                <p>
                  <span class="connectTitle">年龄</span>
                  <span class="connectText">42</span>
                  <span class="connectTitle">意向部位</span>
                  <span class="connectText">手部</span>
                </p>
                <p>
                  <span class="connectTitle">所在城市</span>
                  <span class="connectText">广东省广州市</span>
                  <span class="connectTitle">成交部位</span>
                  <span class="connectText">手部</span>
                </p>
              </div>
            </el-row>
          ...
          <div class="grid-content bg-purple-dark">
            ...
            <el-row style="margin-top: 10px;height: 300px;overflow: auto">
              ...
              <el-radio-group v-model="radioData">
                <el-radio v-for="(item,index) in departmentPersonData" :key="index" :label="index"
                          style="margin:6px 300px 6px 10px">{{item}}
                </el-radio>
              </el-radio-group>
            </el-row>
          </div>
