    ...
    <el-row class="page">
        ...
        >
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-button type="text" size="small" @click="goSettlementDetail">
                查看
              </el-button>
      ...
      <el-col :span="24">
        <div style="width: 95%;margin: 10px auto;">
          ...
          <span style="margin-left: 20px;margin-right: 5px">结算总计:</span>9999
...
<script>
  ...
  export default {
    ...
    methods: {
      // 前往结算记录详情页面
      goSettlementDetail() {
        this.$router.push({path:'/shop/settlementDetail'})
      },
      // 返回上一页
      goBack() {
        this.$router.go(-1);
