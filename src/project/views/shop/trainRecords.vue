    ...
    <el-row class="page">
        ...
        >
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-button type="text" size="small" @click="goTrainDetail">
                查看
              </el-button>
      ...
      <el-col :span="24">
        <div style="width: 95%;margin: 10px auto;">
          ...
          <span style="margin-left: 30px;margin-right: 5px">培训总人数:</span>999999
        ...
        <el-col :span="16">
          <div class="grid-content bg-purple-dark connectBaseInfo">
            ...
            <el-row>
              ...
              <div>
                <p>
                  <span class="connectTitle">订单编号</span>
                  <span class="connectText">1354687945</span>
                  <span class="connectTitle">疗程部位</span>
                  <span class="connectText">手臂</span>
                </p>
                <p>
                  <span class="connectTitle">顾客姓名</span>
                  <span class="connectText">张学友</span>
                  <span class="connectTitle">疗程阶段</span>
                  <span class="connectText">第一次疗程</span>
                </p>
                <p>
                  <span class="connectTitle">性别</span>
                  <span class="connectText">男</span>
                  <span class="connectTitle">操作员</span>
                  <span class="connectText">刘德华</span>
                </p>
                <p>
                  <span class="connectTitle">成交价格</span>
                  <span class="connectText">3999</span>
                  <span class="connectTitle">策单员</span>
                  <span class="connectText">郭富城</span>
                </p>
                <p>
                  <span class="connectTitle">欠款金额</span>
                  <span class="connectText">1200</span>
                  <span class="connectTitle">美容师</span>
                  <span class="connectText">黎明</span>
                </p>
              </div>
            </el-row>
            <el-row>
              <p style="font-size: 17px;margin: 30px 0 10px">抄送人</p>
              <div>
                <span class="connectTitle">刘德华、张学友</span>
              </div>
            </el-row>
          </div>
        </el-col>
...
<script>
  ...
  export default {
    ...
    methods: {
      // 前往培训记录详情页面
      goTrainDetail() {
        this.$router.push({path:'/shop/trainDetail'})
      },
      // 返回上一页
      goBack() {
        this.$router.go(-1);
      ...
      // 新增培训记录
      toCreate() {
        this.$router.push({path:'/shop/addTrain'});
      },
      // 转交给其他人审批
      otherPersonCheck() {
