        ...
        >
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-button type="text" size="small" @click="goEquipmentDetailPage">
                查看
              </el-button>
              <el-button type="text" size="small" @click="goEquipmentMessagePage">
                编辑
              </el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 前往设备信息页面
      goEquipmentMessagePage() {
        this.$router.push({path:'/equipment/addOrEditEquipment'});
      },
      // 前往地图分布页面
      goMapPage() {
